...
export default function Student() {
  ...
  return (
    <>
      ...
      (
        <div>
          <h1>Siz uchun eng yaxshi ustozlar</h1>

          <p className="mt-5 mb-5 w-full">
          Ingliz tilini yaxshilashning ajoyib usulini qidiryapsizmi? ushbu platforma sizni malakali ingliz tili o'qituvchilari bilan ta'minlaydi. Ingliz tilini o'rganishingizga yordam beradigan onlayn ingliz tili o'qituvchisini toping.
          </p>
          {isTablet ? (
            <form>
